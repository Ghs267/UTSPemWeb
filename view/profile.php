			...
			<div class="profile-sidebar">
				...
				<div class="profile-usertitle">
					<div class="profile-usertitle-name">
                        <?php
                        //username
                        echo '<b style="font-size:1.2em;">' . $user. '</b><br>';
					...
					<div class="profile-usertitle-job">
                        <?php
                            $query = "SELECT birth_date from account WHERE username='".$user."'";
		...
		<div class="col-md-9">
            <div class="profile-content ">
                <div class="post">
                    <!-- SHOW POST -->
                    <?php 
                        $query = "SELECT * FROM post JOIN account ON post.username = account.username WHERE account.username = '".$user."'";
                        $result = $db->query($query);
                        echo '<div>';
                        foreach($result as $p){
                            echo '<div class="card">';
                            ...
                            <form action="../controller/addcomment_user.php?username='.$user.'" method ="post">
                            <input type="text" name="comment" placeholder="Add comment.."/>
                            <button value="'.$p[1].'" name="postId" class="-button" type="submit">Comment</button>
                            </form>
                            </div>
                            </div>';
                        }
